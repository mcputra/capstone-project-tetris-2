...
st.set_page_config(layout="wide", page_title="Hubungan Status Ekonomi dengan Tingkat Penyelesaian Sekolah - Capstone Project DQLab Tetris Program Batch 2 - Muhammad Chandra Putra")

components.html(
    """
    <h1 style="text-align: center">Hubungan Status Ekonomi dengan Tingkat Penyelesaian Sekolah</h1>
    <h2 style="text-align: center">Capstone Project DQLab Tetris Program Batch 2 - Muhammad Chandra Putra</h2>
